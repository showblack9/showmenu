...
namespace ShowMenu;
public static class ShowCheats
{
    ...
    public static void sabotageCheat(ShipStatus shipStatus)
    {
        ...
        ShowSabotageSystem.handleReactor(shipStatus, currentMapID);
        ShowSabotageSystem.handleOxygen(shipStatus, currentMapID);
        ShowSabotageSystem.handleComms(shipStatus, currentMapID);
        ShowSabotageSystem.handleElectrical(shipStatus, currentMapID);
        ShowSabotageSystem.handleMushMix(shipStatus, currentMapID);
        ShowSabotageSystem.handleDoors(shipStatus);
    }
