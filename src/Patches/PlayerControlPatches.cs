...
public static class PlayerControl_FixedUpdate
{
    public static void Postfix(PlayerControl __instance){
        ...
        if (__instance.AmOwner){
            ShowCheats.noKillCdCheat(__instance);
        }
...
public static class PlayerControl_CmdCheckMurder
{
    ...
    public static bool Prefix(PlayerControl __instance, PlayerControl target){
        ...
        if (CheatToggles.killAnyone || CheatToggles.zeroKillCd || Utils.isVanished(__instance.Data) || Utils.isMeeting || (ShowPPMCheats.oldRole != null && !Utils.getBehaviourByRoleType((AmongUs.GameOptions.RoleTypes)ShowPPMCheats.oldRole).IsImpostor)){
