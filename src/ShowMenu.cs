...
public partial class ShowMenu : BasePlugin
{
    public Harmony Harmony { get; } = new(Id);
    public static string showVersion = "0.0.1";
    ...
    public override void Load()
    {
        ...
        menuKeybind = Config.Bind("ShowMenu.GUI",
                                "Keybind",
                                "Delete",
        ...
        menuHtmlColor = Config.Bind("ShowMenu.GUI",
                                "Color",
                                "",
                                "A custom color for your ShowMenu GUI. Supports html color codes");

        guestMode = Config.Bind("ShowMenu.GuestMode",
                                "GuestMode",
                                false,
        ...
        guestFriendCode = Config.Bind("ShowMenu.GuestMode",
                                "FriendName",
                                "",
        ...
        spoofLevel = Config.Bind("ShowMenu.Spoofing",
                                "Level",
                                "",
        ...
        spoofPlatform = Config.Bind("ShowMenu.Spoofing",
                                "Platform",
                                "",
        ...
        spoofDeviceId = Config.Bind("ShowMenu.Privacy",
                                "HideDeviceId",
                                true,
        ...
        noTelemetry = Config.Bind("ShowMenu.Privacy",
                                "NoTelemetry",
                                true,
        ...
        SceneManager.add_sceneLoaded((Action<Scene, LoadSceneMode>) ((scene, _) =>
        {
            if (scene.name == "MainMenu")
            {
                ...
                if (!supportedAU.Contains(Application.version)){
                    Utils.showPopup("\nThis version of ShowMenu and this version of Among Us are incompatible\n\nInstall the right version to avoid problems");
                }
            }
        }));
    }
