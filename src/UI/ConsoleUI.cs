...
namespace ShowMenu
{
    public class ConsoleUI : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            if(ColorUtility.TryParseHtmlString(ShowMenu.menuHtmlColor.Value, out configUIColor)){
                GUI.backgroundColor = configUIColor;
            }

            windowRect = GUI.Window(1, windowRect, (GUI.WindowFunction)ConsoleWindow, "ShowConsole");
        }
